...
export const GET_MODULES_STATUS = 'GET_MODULES_STATUS';
...
export const GET_MAX_FEES = 'GET_MAX_FEES';
export const GET_THRESHOLD_VALUES = 'GET_THRESHOLD_VALUES';
...
export const GET_HTM_FEEDBACKS = 'GET_HTM_FEEDBACKS';

export const GET_FAVORITE_HTMS = 'GET_FAVORITE_HTMS';
export const ADD_FAVORITE_HTM = 'ADD_FAVORITE_HTM';
export const REMOVE_FAVORITE_HTM = 'REMOVE_FAVORITE_HTM';

export const ADD_TRUSTED_HTM = 'ADD_TRUSTED_HTM';
export const REMOVE_TRUSTED_HTM = 'REMOVE_TRUSTED_HTM';

export const SAVE_PUSH_TOKEN = 'SAVE_PUSH_TOKEN';
export const GET_CHAT_ROOMS = 'GET_CHAT_ROOMS';
export const CHECK_TRADING_FEEDBACK = 'CHECK_TRADING_FEEDBACK';
export const CHECK_TRADING_PAYMENT = 'CHECK_TRADING_PAYMENT';
...
export const GET_CHANNEL_FEEDBACK = 'GET_CHANNEL_FEEDBACK';
export const UPDATE_CHAT_ROOM_MEMBER_DETAIL = 'UPDATE_CHAT_ROOM_MEMBER_DETAIL';
export const GET_ACTIVE_HTM_TRADE = 'GET_ACTIVE_HTM_TRADE';
export const GET_HTM_TRADE = 'GET_HTM_TRADE';
export const ADD_HTM_TRADE = 'ADD_HTM_TRADE';
export const CANCEL_HTM_TRADE = 'CANCEL_HTM_TRADE';
export const REJECT_HTM_TRADE = 'REJECT_HTM_TRADE';
export const ACCEPT_HTM_TRADE = 'ACCEPT_HTM_TRADE';
export const OPEN_HTM_TRADE = 'OPEN_HTM_TRADE';

// Trade Ads
export const ADD_HTM_TRADE_AD = 'ADD_HTM_TRADE_AD';
export const EDIT_HTM_TRADE_AD = 'EDIT_HTM_TRADE_AD';
export const UPADTE_HTM_TRADE_AD = 'UPADTE_HTM_TRADE_AD';
export const REMOVE_HTM_TRADE_AD = 'REMOVE_HTM_TRADE_AD';
export const FIND_HTM_TRADE_ADS = 'FIND_HTM_TRADE_ADS';
export const MY_HTM_TRADE_ADS = 'MY_HTM_TRADE_ADS';
export const FIND_HTM_TRADE_ADS_FILTER_APPLY = 'FIND_HTM_TRADE_ADS_FILTER_APPLY';
...
//Wagering
export const GET_ORACLE_PROFILE_ACCESS_LIST = 'GET_ORACLE_PROFILE_ACCESS_LIST';
