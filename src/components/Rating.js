...
const STAR_IMAGE = require('@images/rating-w.png');
...
export default class Rating extends Component {
    ...
    constructor(props) {
        ...
        const panResponder = PanResponder.create({
            ...
            onPanResponderMove: (event, gesture) => {
                ...
                if (gesture.dx < ((-this.props.ratingCount + 2 *
                    this.props.minValue) * this.props.imageSize) / 2) {
                    dx = ((-this.props.ratingCount + 2 * this.props.minValue) *
                        this.props.imageSize) / 2;
                } else {
                    dx = gesture.dx;
                }
    ...
    displayCurrentRating() {
        ...
        return (
            <View style={styles.showRatingView}>
                ...
                <View>
                    {readonly && <Text style={styles.readonlyLabel}>
                        (readonly)
                    </Text>}
                </View>
            </View>
    ...
    render() {
        const { readonly, type, ratingImage, ratingColor,
            ratingBackgroundColor, style, showRating } = this.props;
