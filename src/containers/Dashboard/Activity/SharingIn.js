...
class SharingIN extends Component<{}> {
    ...
    componentDidMount(){
        this.props.getSharingInTransactions(0,true);
    }
                ...
                <FlatList
                    refreshControl={
                        <RefreshControl
                            ...
                            tintColor='#191714'
                            refreshing={false}
                            onRefresh={()=>this.props.getSharingInTransactions(0,true)}/>
                    }
                    ...
                    onEndReached={()=>(this.props.txns.length < this.props.total_txns) && !this.props.retrieve &&
                            this.props.getSharingInTransactions(this.props.txns.length)}
...
function mapStateToProps({params}) {
    return {
        txns: params.sharingInTxns || [],
        total_txns: params.sharingInTxns_total || 0,
        txnLoader: params.txnLoader || false,
        txnDetail: params.txnDetail || {},
        loading: params.sharingInTxns_loading || false,
        retrieve: params.sharingInTxns_retrieve || false,
...
export default connect(mapStateToProps, mapDispatchToProps)(SharingIN);
