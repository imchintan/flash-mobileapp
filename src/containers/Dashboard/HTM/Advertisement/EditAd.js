...
class HTMEditAd extends Component < {} > {
    ...
    constructor(props) {
        super(props);
        let buy_currency = constants.CURRENCY_TYPE_UNIT_UPCASE[this.props.htmAd.buy]
        let sell_currency = constants.CURRENCY_TYPE_UNIT_UPCASE[this.props.htmAd.sell]
        this.state = {
            ...this.props.htmAd,
            terms: this.props.htmAd.terms || '',
            sell: {
                currency_type: this.props.htmAd.sell,
                currency_name: `${constants.CURRENCY_TYPE_NAME[sell_currency]} (${sell_currency})`
            },
            buy: {
                currency_type: this.props.htmAd.buy,
                currency_name: `${constants.CURRENCY_TYPE_NAME[buy_currency]} (${buy_currency})`
            },
    ...
    updateAd(){
        ...
        this.props.updateHTMAd(this.props.htmAd.id, data,this.props.navigation.goBack);
    }
        ...
        return(
            <Container>
                <Header>
                    ...
                    <HeaderTitle>Edit Ad</HeaderTitle>
                </Header>
                <Content bounces={false} style={styles.content}>
                    <View style={styles.htmProfileContent}>
                        ...
                        <Button style={{margin: 20}}
                            onPress={this.updateAd.bind(this)}
                            value={'Save'} />
...
export default connect(mapStateToProps, mapDispatchToProps)(HTMEditAd);
