...
class EditHTMProfile extends Component < {} > {
    ...
    constructor(props) {
        super(props);
        let currency_types =  this.props.htmProfile.currencies.length > 0 ?
        ...
        this.state = {
            ...
            currency_types,
            fiat_currency_codes: this.props.htmProfile.fiat_currencies.map(c=>c.currency_code)
        };
    }
