...
class EditProfile extends Component<{}> {
    ...
    updateProfile(){
        ...
        this.props.updateOracleProfile(data,this.props.navigation.goBack);
    }
            ...
            <Container>
                ...
                <Content>
                    <View style={styles.oracleProfileContent}>
                        ...
                        {/*
                            <TouchableOpacity style={styles.oracleActiveDeactiveLink}
                            onPress={()=>{
                                Alert.alert(
                                  'Deactivate Oracle Profile',
                                  'Are you sure, you want to deactivate oracle profile?',
                                  [
                                    {text: 'Cancel', style: 'cancel'},
                                    {text: 'OK', onPress: () => this.props
                                        .disableOracleProfile(this.props.navigation.goBack)},
                                  ],
                                )
                            }}>
                            <Text style={styles.oracleActiveDeactiveLinkText}>
                                Deactivate Oracle Profile
                            </Text>
                        </TouchableOpacity>*/}
                    </View>
